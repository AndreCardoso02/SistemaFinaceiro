...
namespace Infra.Repositorio
{
    public class RepositorioDespesa : RepositoryGenerics<Despesa>, InterfaceDespesa
    {
        ...
        public async Task<IList<Despesa>> ListarDispesasNaoPagasUsuario(string emailUsuario)
        {
        ...
        public async Task<IList<Despesa>> ListarDispesasUsuario(string emailUsuario)
        {
            using (var banco = new ContextBase(_OptionsBuilder))
            {
                var despesas = await
